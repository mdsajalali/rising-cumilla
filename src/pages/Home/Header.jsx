...
const Header = () => {
  ...
  return (
    <div className="flex items-center  justify-around pt-5 px-5 relative">
      <div>
        <div className="cursor-pointer" onClick={() => setClick(!click)}>
          <TbMenu2 size={25} />
        </div>
        {click && (
          <nav className="w-[250px] bg-white list-none  cursor-pointer absolute top-0 left-0 min-h-screen ">
            <img
